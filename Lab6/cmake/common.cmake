...
function(enable_cpp17)
    ...
    set(CMAKE_C_STANDARD_REQUIRED 11 PARENT_SCOPE)

    if (NOT CMAKE_CXX_COMPILER_ID MATCHES "MSVC")
        set(COMPILER_FLAGS "--std=c++17" PARENT_SCOPE)
        set(COMPILER_DEBUG_FLAGS "-D_DEBUG" PARENT_SCOPE)
        set(COMPILER_RELEASE_FLAGS "-O3 -DNDEBUG" PARENT_SCOPE)
        set(LINKER_FLAGS "--std=c++17" PARENT_SCOPE)
    endif()
endfunction()

function(enable_cpp14)
...
# source of code: https://stackoverflow.com/questions/14231292/cmake-and-compiler-warnings
...
## TODO ogarnac to: https://stackoverflow.com/a/9843594/1350091
